            ...
            this.daftarProduk.forEach((produk, index) => {
                ...
                <div class="flex justify-between">
                    <div>
                        ...
                        ${produk.harga} <br> 
                        Stok: ${produk.stok} <br>
                        <button onclick="aplikasiDaftarProduk.editProduk(${index})" class="btn btn-dark btn-xs">Edit</button> 
                        <button onclick="aplikasiDaftarProduk.hapusProduk(${index})" class="btn btn-dark btn-xs">Hapus</button> <br>
                    </div>
                    <div>
