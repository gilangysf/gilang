        ...
        if (this.daftarKategori === null) {
            ...
            this.daftarKategori.forEach((kategori, index) => {
                componentDaftarKategori.innerHTML += 
                    ...
                    <button onclick="kategoriProduk.editKategori(${index})" class="btn btn-black btn-xs">Edit</button> 
                    <button onclick="kategoriProduk.hapusKategori(${index})" class="btn btn-white btn-xs">Hapus</button> <br>`;
            });
        }
    },
