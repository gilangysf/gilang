    ...
    menampilkanDaftarKonsumen: function () {
        ...
        if (this.daftarKonsumen === null) {
            ...
            this.daftarKonsumen.forEach((konsumen, index) => {
                ...
                <button onclick="halamanKonsumen.editKonsumen(${index})" class="btn btn-dark btn-xs">Edit</button> 
                <button onclick="halamanKonsumen.hapusKonsumen(${index})" class="btn btn-white btn-xs">Hapus</button> <br>`;
            });
        }
    },
